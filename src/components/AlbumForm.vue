...
<div class="album-form container mt-3">
    ...
    <form v-on:submit.prevent="onSubmit">
        ...
        <div class="custom-file">
            <input type="file" required accept="image/*"  class="custom-file-input" id="customFileLang" multiple @change="onFileSelected" />
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            if (!(this.isAlbumTitleValid) || this.selectedFiles == null || this.selectedFiles.length == 0) {
                this.$notify({
